...
BOARD_CUSTOM_MKBOOTIMG := $(COMMON_PATH)/mkbootimg/mkbootimg
...
TARGET_PREBUILT_DTB := device/samsung/starlte-kernel/dtb.img
BOARD_INCLUDE_DTB_IN_BOOTIMG := true
BOARD_PREBUILT_DTBIMAGE_DIR := device/samsung/starlte-kernel/dtb
PRODUCT_COPY_FILES += \
